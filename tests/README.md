...
| `children.mjs` | Multiple children: per-child lists/settings/points, ONE parent-only selection — the dashboard child tab doubles as the device pick (no kid-facing switcher), add/rename/remove, device pick persistence |
